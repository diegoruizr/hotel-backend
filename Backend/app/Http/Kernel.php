...
class Kernel extends HttpKernel
{
     ...
     *
     * Los middleware se ejecutan durante cada solicitud a su aplicación..
     *
     * @var array
     */
     ...
     *
     * Los middleware pueden ser asignados a grupos o usados individualmente..
     *
     * @var array
     */
    protected $routeMiddleware = [
        ...
        'verify' => \App\Http\Middleware\VerifyState::class,
    ];
